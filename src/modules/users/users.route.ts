...
export default class AuthRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/`, protect, check_access("get_users"), this.usersController.getAll_admin);
    this.router.get(`${this.path}/:username/info`, protect, check_access("get_users"), this.usersController.profileByUsername_admin);
    this.router.get(`${this.path}/:username/downloads`, protect, check_access("get_users"), this.usersController.getUserDownloads);
