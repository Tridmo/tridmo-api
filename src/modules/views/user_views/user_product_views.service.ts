import UserProductViewsDAO from "./dao/user_product_views.dao";
import { IUserProductView, ICreateUserProductView, IGetUserProductViewFilters } from "./interface/user_product_views.interface";
